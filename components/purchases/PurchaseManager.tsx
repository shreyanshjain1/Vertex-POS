    ...
    <div className="grid gap-6 xl:grid-cols-[0.95fr_1.05fr]">
      <Card>
        ...
        <div className="grid gap-4">
          <select className="w-full rounded-xl border border-stone-300 bg-stone-50 px-4 py-2.5 text-sm" value={supplierId} onChange={(e) => setSupplierId(e.target.value)}>
          ...
          <select className="w-full rounded-xl border border-stone-300 bg-stone-50 px-4 py-2.5 text-sm" value={status} onChange={(e) => setStatus(e.target.value as 'DRAFT' | 'RECEIVED')}>
          ...
          <div className="grid gap-3 md:grid-cols-3">
            <select
              ...
              onChange={(e) => {
                ...
                const hit = products.find((product) => product.id === e.target.value);
                if (hit) setUnitCost(hit.cost);
              }}
            >
