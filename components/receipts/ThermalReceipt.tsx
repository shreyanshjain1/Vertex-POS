...
export default function ThermalReceipt({
  ...
  return (
    <div className="space-y-4">
      ...
      <div
        className={`receipt-root mx-auto rounded-3xl border border-stone-200 bg-white shadow-sm ${compact ? 'p-4' : 'p-5'}`}
      ...
      >
        ...
        <div
          className={`space-y-1 border-b border-dashed border-stone-300 py-4 ${compact ? 'text-[10px]' : 'text-[11px]'} text-stone-700`}
        >
        ...
        {sale.notes ? (
          <div
            className={`border-b border-dashed border-stone-300 py-4 ${compact ? 'text-[10px]' : 'text-[11px]'} text-stone-600`}
          >
